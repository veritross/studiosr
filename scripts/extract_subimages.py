...
def main():
    ...
    # LRx2 images
    opt["input_folder"] = "data/DIV2K/DIV2K_train_LR_bicubic/X2"
    opt["save_folder"] = "data/DIV2K/DIV2K_train_LR_bicubic/X2_sub"
    opt["crop_size"] = 240
    opt["step"] = 120
    opt["thresh_size"] = 0
    # extract_subimages(opt)
    ...
    opt["save_folder"] = "data/DIV2K/DIV2K_train_LR_bicubic/X3_sub"
    opt["crop_size"] = 160
    opt["step"] = 80
    opt["thresh_size"] = 0
    # extract_subimages(opt)
