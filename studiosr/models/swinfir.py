...
class Upsample(nn.Sequential):
    ...
    def flops(self):
        # TODO: calculate flops for Upsample
        return 0.0
...
class SwinFIR(BaseModule):
    """SwinFIR
        A PyTorch impl of : `SwinFIR: Revisiting the SwinIR with Fast Fourier Convolution and Improved Training for Image Super-Resolution
